...
powe[0] = power/100000 + 48; // Add 48 to get the ASCII character value
powe[1] = (power/10000)%10 + 48;
powe[3] = (power/1000)%10 + 48;
powe[4] = (power/100)%10 + 48;

Lcd_Out(1,6,msg3);           // Write message1 in 1st row
Lcd_Out(1,1,powe);
Lcd_out(2,1,"            ");
delay_ms(100);
}
